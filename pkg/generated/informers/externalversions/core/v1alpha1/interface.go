...
type Interface interface {
	// Articles returns a ArticleInformer.
	Articles() ArticleInformer
...
// Articles returns a ArticleInformer.
func (v *version) Articles() ArticleInformer {
	return &articleInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
